...
const NewArrivals = () => {
    ...
    useEffect(() => {
        if (!loading && newProducts && newProducts.length > 0 && !isBoundsInitialized) {
            const prices = newProducts.map((p) => parseFloat(p.price));
    ...
    }, [newProducts, loading, isBoundsInitialized]);
            ...
            <div className="max-w-[1440px] mx-auto px-6 py-12">
                ...
                <div className="mb-12">
                    ...
                    <p className="text-black/60">
                        Showing {filteredProducts.length} of {newProducts?.length || 0} results
                    </p>
                </div>
